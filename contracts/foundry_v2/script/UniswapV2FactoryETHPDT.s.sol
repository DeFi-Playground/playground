...
contract UniswapV2FactoryETHPDTScript is Script {
  ...
  function run() public {
    ...
    (address pair) = IUniswapV2Factory(factory).getPair(eth, pdt);
    ...
    (address deployedPair) = IUniswapV2Factory(factory).createPair(eth, pdt);
